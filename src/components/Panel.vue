<template>
  <div
    class="relative flex justify-center bg-white rounded px-5 pt-5 capitalize cursor-pointer shadow-sm transition duration-500 ease-in-out hover:shadow-2xl transform hover:-translate-y-1 hover:scale-120"
  >
